...
if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1') {
    ...
    $data = array(
        ...
        'plantoken' => $plantoken,
        'clube_bonus' => $clube_bonus,
        'pro_commission'=> $pro_commission,
        'dipo_commission' => $dipo_commission,
        'dilar_commission' => $dilar_commission,
        'office_rent' => $office_rent,
        'staf_fee' => $staf_fee,
        'entertainment_fee' => $entertainment_fee,
    );
                    ...
                    <div class="card-body">
                        <div class="tab-content no-padding" id="myTab2Content">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="currencysym" id="currencysym" class="form-control" value="<?php echo isset($bpprow['currencysym']) ? $bpprow['currencysym'] : 'BDT'; ?>" placeholder="BDT" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="currencycode" id="currencycode" class="form-control" value="<?php echo isset($bpprow['currencycode']) ? $bpprow['currencycode'] : 'BDT'; ?>" placeholder="BD" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="bpptab3" role="tabpanel" aria-labelledby="config-tab3">
                                <div class="form-group">
                                <label for="cmdrlist">Referral Commission</label>
                                ...
                                <div class="form-group">
                                    <label for="cmlist">Genaretion Commission</label>
                                ...
                                <div class="form-group">
                                    <label for="rwlist">Matching Commission</label>
                                ...
                                <div class="form-group">
                                    <label for="rwlist">Clube Bonus</label>
                                    <textarea class="form-control rowsize-sm" name="clube_bonus" id="clube_bonus" placeholder="Reward value, separated with comma"><?php echo isset($bpprow['clube_bonus']) ? $bpprow['clube_bonus'] : ''; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="rwlist">Promossion Commission</label>
                                    <textarea class="form-control rowsize-sm" name="pro_commission" id="pro_commission" placeholder="Reward value, separated with comma"><?php echo isset($bpprow['pro_commission']) ? $bpprow['pro_commission'] : ''; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="rwlist">Dipu Commission</label>
                                    <textarea class="form-control rowsize-sm" name="dipo_commission" id="dipo_commission" placeholder="Reward value, separated with comma"><?php echo isset($bpprow['dipo_commission']) ? $bpprow['dipo_commission'] : ''; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="rwlist">Delar Commission</label>
                                    <textarea class="form-control rowsize-sm" name="dilar_commission" id="dilar_commission" placeholder="Reward value, separated with comma"><?php echo isset($bpprow['dilar_commission']) ? $bpprow['dilar_commission'] : ''; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="rwlist">Office Rent</label>
                                    <textarea class="form-control rowsize-sm" name="office_rent" id="office_rent" placeholder="Reward value, separated with comma"><?php echo isset($bpprow['office_rent']) ? $bpprow['office_rent'] : ''; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="rwlist">Staf</label>
                                    <textarea class="form-control rowsize-sm" name="staf_fee" id="staf_fee" placeholder="Reward value, separated with comma"><?php echo isset($bpprow['staf_fee']) ? $bpprow['staf_fee'] : ''; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="rwlist">Entertainment</label>
                                    <textarea class="form-control rowsize-sm" name="entertainment_fee" id="entertainment_fee" placeholder="Reward value, separated with comma"><?php echo isset($bpprow['entertainment_fee']) ? $bpprow['entertainment_fee'] : ''; ?></textarea>
                                </div>
                            </div>
