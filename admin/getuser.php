                ...
                <div class="card profile-widget">
                    ...
                    <div class="profile-widget-description">
                        ...
                        <h6 class="text-small"><span class="badge badge-light">
                                <?php
                                if ($rowstr['reg_date'] != $rowstr['reg_expd'] && $bpprow['expday'] > 0) {
            ...
            <article class="article mt-4">
                <div class="article-header">
                    ...
                    <div class="article-title">
                        <h2 class="badge badge-primary"><?php echo ($bpprow['ppname']) ? myvalidate($bpprow['ppname']) : $cfgrow['site_name']; ?> - <?php echo ($bpprow['regfee'] > 0) ? myvalidate($bpprow['currencysym'] . $bpprow['regfee'] . ' ' . $bpprow['currencycode']) : 'FREE'; ?> <?php echo myvalidate($outplanreg); ?>
                        </h2>
                    </div>
                </div>
                <div class="article-details">
                    <div><?php echo ($bpprow['planinfo']) ? myvalidate($bpprow['planinfo']) : ''; ?>
                    </div>
