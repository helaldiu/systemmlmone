...
// $sql = $db->getRecFrmQry("SELECT * FROM " . DB_TBLPREFIX . "_mbrs WHERE 1 ");
        ...
        $recentwdr .= "<li class='media'>
                            ...
                            <div class='media-body'>
                                ...
                                <span class='text-small text-muted'>
                                    <div><a href='index.php?hal=getuser&getId={$usrwdrstr['id']}' data-toggle='tooltip' title='{$usrwdrstr['fullname']}'>{$usrwdrstr['username']}</a></div>
