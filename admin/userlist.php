...
if (count($userData) > 0) {
    ...
    foreach ($userData as $val) {
        ...
        $optviewcycle .= "<a class='dropdown-item' href='index.php?page={$pagestr}&ipp={$ippstr}&hal=userlist&dohal=filter&doval={$filterusrstr['id']}&dompid={$val['mpid']}&cyclist={$icyc}'>" . strtoupper($filterusrstr['username']) . " Cycle {$icyc}{$ismarked}</a>";
    }
}
            ...
            <tbody>
                ...
                if (count($userData) > 0) {
                    ...
                    foreach ($userData as $val) {
                        ...
                        $isusercyc = ($val['cyclingbyid'] > 0) ? ' (&uarr;)' : '';
                        ...
                        <tr>
                            ...
                            <td data-toggle='tooltip' title='<?php echo myvalidate($val['firstname'] . ' ' . $val['lastname']); ?>'><?php echo myvalidate($isuseron . $val['username'] . $isusercyc); ?></td>
