                ...
                if (count($userData) > 0) {
                    ...
                    foreach ($userData as $val) {
                        ...
                        if ($val['txstatus'] == 2) {
                            ...
                            if ($val['txfromid'] == 0) {
                                $statussign = ($val['txstatus'] == 1) ? '&#9662;' : '&#9663;';
                                $bletmark = '<span class="text-danger">' . $statussign . '</span>';
                            } elseif ($val['txtoid'] == 0) {
                                $statussign = ($val['txstatus'] == 1) ? '&#9652;' : '&#9653;';
                                $bletmark = '<span class="text-success">' . $statussign . '</span>';
                            } else {
                                $bletmark = '<span class="bullet text-muted" data-toggle="tooltip" title="' . $statusttip . '"></span>';
                            }
                        }
