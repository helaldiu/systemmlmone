...
$regfee = $totcoinpayments = $totstripe = $totperfectmoney = $totpaypal = $totpayfast = $totpaystack = $totmanualpay = $tottestpay = $mbrstr['reg_fee'];

$paytoken = $payrow['paytoken'];
$isppsandbox = get_optionvals($paytoken, 'paypalsbox');

$ispayg = 0;
$paygatearr = array('coinpayments', 'perfectmoney', 'paypal', 'stripe', 'payfast', 'paystack', 'manualpay', 'testpay');
